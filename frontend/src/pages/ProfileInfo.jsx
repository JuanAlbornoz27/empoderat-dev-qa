...
const ProfileInfo = () => {
  ...
  // Cargar datos del perfil usando el email de localStorage
  useEffect(() => {
    const fetchUserProfile = async () => {
      try {
        ...
        if (!email) {
          setError('No se pudo encontrar información del usuario');
          setLoading(false);
          return;
        }
  ...
  // Actualizar usuarioTemporal cuando cambia usuario
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="perfil-container">
        {loading ? (
          <div className="loading-spinner">Cargando información del perfil...</div>
        ) : error ? (
